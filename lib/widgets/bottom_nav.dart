...
// }
import 'package:flutter/material.dart';
// import 'package:netflixclone/screens/games_screen.dart';
// import 'package:netflixclone/screens/home_screen.dart';
// import 'package:netflixclone/screens/new_screen.dart';
// import 'package:netflixclone/screens/profile_screen.dart';
              ...
              Tab(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 4,
                    ), // Add some space between emoji and text
                    Text('Games'), // Text for the games tab
                  ],
                ),
              ),
              Tab(icon: Icon(Icons.video_library), text: 'New & Hot'),
              Tab(
                // Use Image.asset to load the profile image
                icon: Image(
                  image: AssetImage('assets/Images/profile2.jpg'),
